...
if(usr!=null && pwd!=null){ 
	...
	if(usr.equals("demo") && pwd.equals("demo1234")){
		request.getSession().setAttribute("cwe759loggedin", true);
		response.sendRedirect("cwe759loggedin.jsp");
	}
	//see if the user account is tried
	if(usr.equals("user")){
		//get the currently generated password from the session
		String sesPwd = (String)session.getAttribute("cwe759userpassword");
		if(sesPwd!=null && sesPwd.equals(pwd)){
			session.setAttribute(Constants.CHALLENGE_ID,"cwe759");
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="#">cwe759 - Use of a One-Way Hash without a Salt</a></li>
...
<div class="container"> 
<p>Welcome to cwe759 - Use of a One-Way Hash without a Salt! You can use the following guest account credentials to login, 
user: <code>demo</code>, password: <code>demo1234</code> </p>
<form action="cwe759.jsp" autocomplete="off" method="POST">
