...
if(session.getAttribute("cwe89loggedin")==null || !(boolean)session.getAttribute("cwe89loggedin")){
	...
	session.setAttribute(Constants.CHALLENGE_ID,"cwe89");
...
<div class="form-inline">
  ...
  <input type="text" class="form-control" id="email" name="email" value="admin@inc.insecure.inc">
</div>
<br>
<div class="form-group">
  <label for="updateServer">Update server:</label>
  <input type="text" class="form-control" id="updateServer" name="updateServer" value="inc.insecure.inc">
</div>
