...
if(usr!=null && pwd!=null){ 
	...
	if(usr.equals("demo") && pwd.equals("demo1234")){
		request.getSession().setAttribute("cwe611loggedin", true);
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="#">cwe611 - XML External Entity</a></li>
  		
    </ul>
  </div>
</nav>
<div class="container"> 
<p>Welcome to cwe611 - XML External Entity! You can use the following guest account credentials to login, 
user: <code>demo</code>, password: <code>demo1234</code> </p>
<form action="cwe611.jsp" autocomplete="off" method="POST" >
